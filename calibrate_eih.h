...
//typedef Eigen::Vector3d   pose6d;        //6by1(double) pose vector(xyzuvw)
...
//typedef Eigen::Vector3d   pose_data;
...
public:
    ...
    //Eigen::MatrixXd svdInverse(Eigen::MatrixXd  A); //square matrix for ur5e, pseudo inverse not necessary
